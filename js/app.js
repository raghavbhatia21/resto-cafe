...
// Initialized via js/license.js
// const LICENSE_ID = 'caferesto-demo';

// Redundant, handled by js/license.js
/*
...
// Load Offers from JSON (Generated by Netlify Build via Decap CMS)
function loadOffers() {
    fetch('offers.json')
        .then(response => {
            if (!response.ok) return {}; // No offers file yet
            return response.json();
        })
        .then(data => {
            renderOffers(data);
